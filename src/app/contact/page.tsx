...
export default function ContactPage() {
  const { addNotification } = useBoutique();
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-8 border border-maroon/5 shadow-luxury">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full font-poppins text-xs uppercase tracking-widest font-bold bg-maroon hover:bg-gold text-gold hover:text-maroon py-4 rounded-full border border-maroon hover:border-gold transition-all duration-300 cursor-pointer"
              >
          ...
          <div className="lg:col-span-5 space-y-8 font-poppins text-xs text-maroon/80">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <span className="leading-relaxed">
                    Beside of MMP Primary School, Ponnangur,<br />
                    Adavibhudhugur Road, Mallanur, Kuppam,<br />
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span>mahathitailorshop@gmail.com</span>
                </div>
              </div>
            ...
            <div className="border border-maroon/5 bg-cream rounded-3xl p-6 h-[200px] flex items-center justify-center text-center relative overflow-hidden shadow-luxury">
              ...
              <div className="space-y-2 z-10">
                ...
                <p className="font-poppins text-[10px] text-maroon/60">Kuppam Chittoor Shop Map directions</p>
                <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="text-[10px] font-bold text-gold-dark hover:underline block pt-2">View on Google Maps</a>
              </div>
            </div>
