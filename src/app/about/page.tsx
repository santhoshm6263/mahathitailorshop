        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center mb-20">
          ...
          <div className="lg:col-span-7 space-y-6">
            <h2 className="font-playfair text-2xl sm:text-3xl font-semibold text-maroon">
              Crafting Flawless Silhouettes Since 2020
            </h2>
            <div className="w-10 h-[1px] bg-gold"></div>
            <p className="font-poppins text-sm leading-relaxed text-maroon/80">
              Founded and curated by <strong>AMMULU JEEVA</strong> beside MMP Primary School in Ponnangur (Kuppam), <strong>Mahathi Tailor Shop</strong> has emerged as a premier atelier for luxury Indian ethnic fashion. Since 2020, we have designed and stitched thousands of bespoke masterpieces, specializing in custom designer bridal blouses and heavy handcrafted Aari embroidery.
            </p>
            <p className="font-poppins text-sm leading-relaxed text-maroon/80">
          ...
          <div className="lg:col-span-5 h-[350px] relative rounded-3xl overflow-hidden shadow-luxury border border-gold/20">
            <img src="/assets/hero-bridal.png" alt="Bridal Lehenga Couture" className="absolute inset-0 w-full h-full object-cover" />
          </div>
