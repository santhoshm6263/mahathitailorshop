  ...
  init() {
    ...
    if (!data) {
      ...
      try {
        ...
        // Migration: Update flagship config if it contains old values or doesn't have the new phone
        if (this.state.config && this.state.config.phone !== '+91 93470 01303') {
          this.state.config = seeds.config;
          this.save();
        }
      } catch (e) {
