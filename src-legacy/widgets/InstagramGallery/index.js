      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="font-poppins text-xs sm:text-sm text-maroon/70 leading-relaxed">
            A visual showcase of finished designer bridal blouses, heavy maggam embroideries, girls pavadais, and handcraft previews captured in our boutique fashion house.
          </p>
        </div>
