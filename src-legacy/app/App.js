    ...
    <section className="relative w-full min-h-screen flex items-center justify-center bg-maroon-dark text-white overflow-hidden pt-[80px]">
      ...
      <div className="max-w-[1440px] w-full mx-auto px-6 lg:px-12 relative z-10 space-y-6">
        <div className="flex items-center space-x-3 mb-2">
          ...
          <span className="font-poppins text-xs tracking-[0.3em] text-gold uppercase">Est. 2020 | Premier Bridal Studio</span>
        </div>
    ...
    <div className="w-full bg-cream-soft rounded-3xl border border-maroon/5 shadow-luxury overflow-hidden p-8 sm:p-10 grid grid-cols-1 lg:grid-cols-12 gap-10">
      ...
      <div className="lg:col-span-4 bg-maroon text-white p-6 sm:p-8 rounded-2xl border border-gold/25 shadow-luxury flex flex-col justify-between relative overflow-hidden">
        ...
        <div className="space-y-6 relative z-10">
          <h4 className="font-playfair text-xl font-bold text-gold pb-4 border-b border-white/10">Our Studio</h4>
          
          <div className="space-y-4 font-poppins text-xs text-white/80">
            <div className="flex items-start space-x-2"><span>📍</span><span>Beside of MMP Primary School, Ponnangur, Adavibhudhugur Road, Mallanur, Kuppam, Chittoor, Andhra Pradesh - 517425</span></div>
            <div className="flex items-start space-x-2"><span>📞</span><span>+91 93470 01303</span></div>
            <div className="flex items-start space-x-2"><span>⏰</span><span>Welcoming you full week, Monday to Sunday, (9am - 9pm) Sunup to Sundown</span></div>
          </div>
        ...
        <div className="border-t border-white/10 pt-6 mt-6 relative z-10 font-poppins text-[10px] text-white/70 space-y-2">
          ...
          <a href="tel:+919347001303" className="text-gold uppercase font-bold tracking-wider hover:underline block pt-2">Call Designer Desk →</a>
        </div>
      </div>
      ...
      <section className="py-24 bg-maroon text-white relative overflow-hidden text-center bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-maroon-light via-maroon to-maroon-dark border-y border-gold/15">
        ...
        <div className="max-w-[1440px] mx-auto px-6 relative z-10 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            <a href="https://wa.me/919347001303" target="_blank" className="font-poppins text-xs uppercase tracking-widest font-bold bg-transparent text-white border border-white/30 px-8 py-4 rounded-full hover:bg-white/10 hover:text-gold transition-all">WhatsApp Designer Desk</a>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 space-y-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-6">
            <h2 className="font-playfair text-2xl sm:text-3xl font-bold">Bespoke Fitting Since 2020</h2>
            <p className="font-poppins text-xs leading-relaxed text-maroon/80">Founded and curated by <strong>AMMULU JEEVA</strong> beside MMP Primary School in Ponnangur (Kuppam), Mahathi Tailor Shop has catered to premium bridal clients since 2020. We specialize in custom designer bridal blouses, heavy Aari zari embroideries, and gorgeous zardosi work.</p>
